...
VQVAE_PATH = MODELS_DIR / "vqvae-trained-psd" / "vqvae-trained-psd.pt"
UNET_DIR = MODELS_DIR / "unet-trained-psd"
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        if SAVE_EVERY_EPOCH:
            save_checkpoint(
                ...
                optimizer=optimizer,
                path=UNET_DIR / f"unet-trained-psd-{epoch}.pt"
            )
        ...
        if avg_val_loss < best_val_loss:
            ...
            save_checkpoint(
                ...
                val_loss=avg_val_loss,
                optimizer=optimizer,
                path=UNET_DIR / "unet-trained-psd.pt"
            )
