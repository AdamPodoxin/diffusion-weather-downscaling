...
# Loss value seems to reach minimum after only 5 epochs,
# then begins rising again, possible overfitting.
NUM_EPOCHS = 5
...
if __name__ == "__main__":
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        for X in tqdm(batch_generator, total=num_batches):
            ...
            loss = torch.nn.functional.l1_loss(output_sample_normalized, X_normalized)
            loss.backward()
