...
from isotropic_fpsd_loss import isotropic_psd_loss, calculate_batch_dx
...
VQVAE_DIR = MODELS_DIR / "vqvae-trained-psd"
...
# Geographical information about our data
MAX_LAT = 54.75
MIN_LAT = 23
CENTER_LAT = (MAX_LAT + MIN_LAT) / 2

PSD_LOSS_MULTIPLIER = 0.13
...
if __name__ == "__main__":
    ...
    center_lats = CENTER_LAT * torch.ones(BATCH_SIZE).to(device)
    batch_dx = calculate_batch_dx(center_lats)
    ...
    for epoch in range(epoch, NUM_EPOCHS):
        ...
        if avg_val_loss < best_val_loss:
            ...
            save_checkpoint(
                ...
                val_loss=avg_val_loss,
                optimizer=optimizer,
                path=VQVAE_DIR / "vqvae-trained-psd.pt"
            )
